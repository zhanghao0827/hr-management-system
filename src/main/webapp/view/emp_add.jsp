...
<script type="text/javascript">
    $(function () {
        ...
        // $.get("DeptServlet", "action=getDepts", function (depts) {
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                    <tr>
                        <td class="font3 fftd">
                            <table>
                                <tr>
                                    <td class="font3 fftd">姓名：<input type="text" name="empName" id="name" size="20"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="email" id="email" size="20"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font3 fftd">手机：<input name="telNum" id="phone" size="20"/></td>
                                    <td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="phone" id="tel" size="20"/>
                                    </td>
                                </tr>
